...
const Tooltip: React.FC<TooltipProps> = ({
  ...
  return (
    ...
    >
      ...
      {isVisible && (
        <div 
          className={`absolute z-50 px-3 py-2 text-sm text-white bg-slate-800 rounded-lg shadow-lg whitespace-nowrap animate-fade-in ${positionClasses[position]} ${className}`}
        >
          {content}
          <div 
