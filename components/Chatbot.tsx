            ...
            >
                ...
                <div className="flex-shrink-0 p-3 border-t border-slate-200 bg-white rounded-b-2xl">
                    <form onSubmit={handleSend} className="flex items-center gap-2">
                        ...
                        />
                        <button type="submit" className="flex-shrink-0 w-11 h-11 bg-indigo-600 text-white rounded-full flex items-center justify-center transition-all duration-200 transform hover:scale-110 hover:bg-indigo-700 disabled:bg-indigo-300 disabled:scale-100" disabled={isLoading || !inputValue.trim()} aria-label="Send message">
                            <SendIcon />
                        </button>
                    </form>
                </div>
